	...
	<html xmlns:x="urn:schemas-microsoft-com:office:excel">
		...
		<?php //var_dump($records);?>
			...
			<div class="half_me">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;THIS IS TO CERTIFY that <b><u><?php echo $client_name;?></u></b> with 
				trade name <b><u><?php echo $client_tradename;?></u></b>, <?php echo $client_address?>
				has been advised to follow RA 9296 known as Meat Inspection Code of the Philippines, as amended by RA 10536. Chicken should be dressed
				in accredited Poultry Dressing Plants and should be stored following AO 5 (Hygienic Handling of Fresh meat) and AO 6 
				(Hygienic Handling of Frozen, Chilled and Thawed Meat).<p>
				<p style="text-align:justify;font-size:15px;line-height:20px;margin-left:40px;margin-right:40px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
