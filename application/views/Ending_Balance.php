			...
			<div class="half_me">
				...
				<?php endif; ?>
					...
					<tbody>
						...
						<tr>
							<td style="border:1px solid;font-size:10px"><?php echo $item->office;?></td>
							<td style="border:1px solid;font-size:10px;text-align:center;"><?php echo $item->office_code;?></td>
							<td style="border:1px solid;font-size:10px;text-align:right;">
								<?php 
									echo number_format($item->totalcost,2);
								?>
							</td>
						</tr>
							<?php
						...
						<tr>
							...
							<td style="border:1px solid;font-size:10px;text-align:right;font-weight:bold;"><?php echo number_format($grandtotal,2);?>
							</td>
						</tr>
					</tbody>
					</table>
