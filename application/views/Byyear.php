	...
	<html xmlns:x="urn:schemas-microsoft-com:office:excel">
		...
		<?php //var_dump($records);?>
			...
			<div class="half_me">
				...
				<br>
				<h3 style="text-align:center;"><b>CERTIFICATION MASTERLIST BP Year <?php echo $client_BPYear;?><br></b></h3>
				<br><br><br><br>
				...
				<thead>
					<tr>
						...
						<th style="font-weight:bold;border:1px solid;width:13%;">TRADE NAME</th>
						<th style="font-weight:bold;border:1px solid;width:11%;">CONTACT</th>
						<th style="font-weight:bold;border:1px solid;width:13%;">BP YEAR</th>
						<th style="font-weight:bold;border:1px solid;width:17%;">BARANGAY</th>
				...
				<?php if($records):?>
					...
					<tr>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_name;?></td>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_address;?></td>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_tradename;?></td>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_contact;?></td>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_BPYear;?></td>
						<td style="border:1px solid;font-size:10px"><?php echo $record->client_barangay;?></td>
					</tr>
					<?php endforeach;?>
				<?php endif;?>
				</tbody>
