		...
		<body>
			...
			<div class="half_me">
				...
				<?php if($formula == "noneweighted"):?>
					<table width="100%">
					<tr>
						<td style="font-weight:normal;width:5px;font-size:70%;border:1px solid;">Item :</td>
						<td colspan="5" style="font-weight:normal;width:58%;font-size:70%;border:1px solid;"><b><?php echo $item_name; ?></b></td>
						<td colspan="2" style="font-weight:normal;width:8%;font-size:70%;border:1px solid;">Item Code :</td>
						<!-- <td style="font-weight:normal;width:8%;font-size:70%;border:1px solid;"><b><//?php echo $stock_no; ?></b></td>
					...
					<tr>
						<td style="font-weight:normal;width:5px;font-size:70%;border:1px solid;">Description :</td>
						<td colspan="5" style="font-weight:normal;width:60px;font-size:70%;border:1px solid;"><b><?php echo $description . "," . $additional_desc . ", " . $brand; ?></b></td>
						<td colspan="2" style="font-weight:normal;width:8%;font-size:70%;border:1px solid;">Re-order Point :</td>
						<!-- <td style="font-weight:normal;width:14%;font-size:70%;border:1px solid;"><b></b></td> -->
					</tr>
					<?php else: ?>
					<tr>
						<td style="font-weight:normal;width:5px;font-size:70%;border:1px solid;">Description :</td>
						<td colspan="5" style="font-weight:normal;width:60px;font-size:70%;border:1px solid;"><b><?php echo $brand . ", " . $description ; ?></b></td>
						<td colspan="2" style="font-weight:normal;width:8%;font-size:70%;border:1px solid;">Re-order Point :</td>
						<!-- <td style="font-weight:normal;width:14%;font-size:70%;border:1px solid;"><b></b></td> -->
					</tr>
					<?php endif; ?>
					<tr>
						<td style="font-weight:normal;width:5px;font-size:70%;border:1px solid;">Unit of Measurement :</td>
						<td colspan="5" style="font-weight:normal;width:60%;font-size:70%;border:1px solid;"><b><?php echo $unit; ?></b></td>
						<td colspan="2" style="font-weight:normal;width:8%;font-size:70%;border:1px solid;"></td>
					</tr>
					<tr>
						<td rowspan="2" style="text-align:left;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Date</td>
						<td colspan="2" style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Reference</td>
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Receipt</td>
						<td colspan="2" style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Issue</td>
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Balance</td>
						<td rowspan="2" style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">No. of Days to Consume</td>
					</tr>
					<tr>
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">PO</td>
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">RIS</td>
						<!-- <td style="text-align:center;font-weight:normal;width:7%;font-size:70%;border:1px solid;">JEV</td> -->
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Qty.</td>
						...
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Qty.</td>
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Office</td>
						<!-- <td style="text-align:center;font-weight:normal;width:7%;font-size:70%;border:1px solid;">Total Cost</td> -->
						<td style="text-align:center;font-weight:normal;width:15%;font-size:70%;border:1px solid;">Qty.</td>
						<!-- <td style="text-align:center;font-weight:normal;width:7%;font-size:70%;border:1px solid;">Unit Cost</td>
						<td style="text-align:center;font-weight:normal;width:7%;font-size:70%;border:1px solid;">Total Cost</td> -->
					...
					<?php if($records): ?>
						...
						?> 
							<tr>
								<td style="font-weight:normal;width:5px;font-size:70%;border:1px solid;"><?php echo $record->trans_date;?></td>
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;"><?php echo $record->po_num;?></td>
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;"><?php echo $record->ris;?></td>
								<!-- <td style="font-weight:normal;width:7%;font-size:70%;border:1px solid;"></td> -->
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;text-align:right;"><?php echo  $record->qty_rec;?></td>
								...
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;text-align:right;"><?php echo $record->qty_issue;?></td>
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;text-align:center;"><?php echo $record->division_unit;?></td>
								...
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;text-align:right;"><?php echo $QtyRbalance;?></td>
								...
								<td style="font-weight:normal;width:15%;font-size:70%;border:1px solid;"><?php echo $record->daysto_consume;?> -- <?php echo $record->remarks;?></td>
							</tr>
						<?php endforeach;?>
					<?php endif;?>
						<tr>
				...
				<table width="100%">
					...
					<?php endif;?>
						<tr>
							<td colspan="8" style="text-align:center;font-weight:normal;width:7%;font-size:70%;border:1px solid;">
								******************************************************NOTHING FOLLOWS******************************************************
							</td>
						</tr>
				</table>
