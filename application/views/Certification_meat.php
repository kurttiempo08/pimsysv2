	...
	<html xmlns:x="urn:schemas-microsoft-com:office:excel">
		...
		<?php //var_dump($records);?>
			...
			<div class="half_me">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;THIS IS TO CERTIFY that <b><u><?php echo strtoupper($client_name);?></u></b> with 
				trade name <b><u><?php echo $client_tradename;?></u></b>, located at <?php echo $client_address?>
				has been advised to follow RA 9296 known as Meat Inspection Code of the Philippines, as amended by RA 10536. Hogs should be 
				slaughtered for ante-mortem and post-mortem inspection at the City Slaughterhouse, Cugman, this city.<p>
				<p style="text-align:justify;font-size:15px;line-height:20px;margin-left:40px;margin-right:40px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
